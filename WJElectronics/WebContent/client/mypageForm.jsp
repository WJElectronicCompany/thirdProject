		...
		<div align="center">
			<div class="jumbotron" style="padding-top: 20px; margin-top: 50px;">
				...
				<form action="/WJElectronics/client/modifyInfo.do?id=${client.id }" method="post" name="mypageForm" onsubmit="return modifyInfoInputCheck()">
					...
					<table border="1" class="colorstyle" style="height: 50%; width: 70%">
						<tr>
							<td  width="50px" align="center">아이디 </td>
							<td width="200px" id="id" align="center">${client.id }</td>
						</tr>
						<tr>
							<td align="center">비밀번호</td>
							<td><input type="password" name="pw" id="pass"  width="200px" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td width="200px"><select name="tel1" id="tel1">
						...
						<tr>
							...
							<td><input type="text" name="address2" size="30" id="address2" value="${client.address2 }"  width="200px"/></td>
						</tr>
						<tr>
